...
import img1 from '../assets/projets/1.jpg';
import img2 from '../assets/projets/2.jpeg';
import img3 from '../assets/projets/3.png';
import { GitBranchPlus, Github, Video } from "lucide-react";
...
const Projet = () => {
  return (
    <div>
        <div className="mt-10" id="Projet">
            <Title titre="Mes Projets" />
